...
var xxType='';
var xxContentId=0;
function init(id,contentId,type,isEnroll){
	/**表情框开始**/
	var faceHtml='';
	...
	if(isEnroll==0){
		...
		html+='<a href="'+_webPath+'train/addScore?id='+contentId+'" class="f16 display-bl flex1 text-center lan"><i class="icon01 comment-ico display-ib ver-2 mr5"></i>评论</a>';
	}
